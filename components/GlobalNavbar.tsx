         ...
         <div className="flex flex-wrap gap-8 items-center w-full md:w-auto">
           <div className="text-left md:text-right">
             ...
             <div className="flex gap-4">
               <a href="https://instagram.com/JOUWNAAM" target="_blank" className="text-[10px] font-bold uppercase tracking-widest hover:text-indigo-600">Instagram</a>
               <a href="https://linkedin.com/in/JOUWNAAM" target="_blank" className="text-[10px] font-bold uppercase tracking-widest hover:text-indigo-600">LinkedIn</a>
             </div>
           </div>
           ...
           <div className="text-left md:text-right md:border-l border-zinc-100 md:pl-8">
             ...
             <a href="mailto:jouw@mail.com" className="text-[10px] font-bold uppercase tracking-widest hover:text-indigo-600">jouw@mail.com</a>
           </div>
         </div>
      </div>
    </motion.div>
